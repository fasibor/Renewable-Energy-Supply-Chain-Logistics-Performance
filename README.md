...
## Core Findings & Visual Summary

```text
                       Logistics Bottlenecks
  ┌───────────────────────┬───────────────────────┬───────────────────────┐
  │     Highest Delays    │  Highest Overruns     │   Highest Damage Rate │
  │    (~7 Days Avg)      │  (₦ Cost Variance)    │      (% Shipped)      │
  ├───────────────────────┼───────────────────────┼───────────────────────┤
  │ • Rivers → Niger      │ • Delta → Rivers      │ • Monitoring Equip:   │
  │ • Oyo → Anambra       │   (₦182.4K)           │   2.23%               │
  │ • Edo → Kwara         │ • Rivers → Kaduna     │ • Cables & Protection:│
  │                       │   (₦155.4K)           │   2.10%               │
  │                       │ • Delta → Edo         │ • Hybrid Inverters:   │
  │                       │   (₦130.8K)           │   2.07%               │
  └───────────────────────┴───────────────────────┴───────────────────────┘
